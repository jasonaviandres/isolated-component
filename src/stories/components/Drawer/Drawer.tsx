            ...
            >
                <div className="absolute inset-0 overflow-y-auto">
                    <Transition.Child {...easeOutTransaction}>
                        <Dialog.Overlay className="absolute inset-0 transition-opacity bg-gray-800 bg-opacity-50 backdrop-blur" />
                    </Transition.Child>
                    <div className="fixed inset-y-0 right-0 w-full max-w-xl">
                        ...
                        >
                            <div className="relative w-full h-screen p-6 overflow-y-auto sm:max-w-xl bg-white">
                                <Transition.Child {...easeOutTransaction}>
                                    <IconButton
                                        icon={
                                            <CloseIcon
